...
For both formats, the actual calibration data is an array of complex doubles (2x64-bit) of shape 
...
## Difference view comparing two calibration fit files

As well as viewing a single calibration fit file, you can also display the difference between two calibration fit
